...
public class TransactionsController {
	   ...
	   AccountServicesIntr accountServicesIntr;
		...
		public ResponseEntity<BankAccount> depositInBankHandler(@PathVariable("accountNumber") long accountNumber, @PathVariable("amount") double amount, @RequestParam String key) {
